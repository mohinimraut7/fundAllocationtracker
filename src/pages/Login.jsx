...
//     // ✅ Collector role ला office select required
...
//             name: data.user.name,
//             role: data.user.role,
//             collectorOffice: form.collectorOffice, // ✅ save selected office
//           })
//         );
//         navigate("/dashboard");
//       } else {
...
//                 // ✅ role change झाल्यावर collectorOffice reset
...
//           {/* ✅ Extra Dropdown only for Collector */}
//           {form.role === "collector" && (
//             <div>
//               <label className="text-sm font-semibold text-gray-600">
...
//                 {collectorData.collectorOffices.map((office, index) => (
...
//   // ✅ Unique Regions
//   const regions = [...new Set(collectorData.collectorOffices.map((o) => o.region))];

//   // ✅ Filter offices by selected region
...
//     // ✅ Collector role ला region + office required
...
//             name: data.user.name,
//             role: data.user.role,
//             region: form.region, // ✅ save
//             collectorOffice: form.collectorOffice, // ✅ save
//           })
//         );
//         navigate("/dashboard");
//       } else {
